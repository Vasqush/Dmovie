...
{{--    Movie Details--}}
    <div class="movie-info border-b border-gray-800">
        <div class="mx-auto px-8 py-8 md:pt-12 flex flex-col md:flex-row">
            <img src="{{'https://image.tmdb.org/t/p/w500/' . $movieDetails['poster_path']}}" alt="{{$movieDetails['title']}}" class="max-w-80 md:w-80">
            <div class="mt-5 md:mt-0 md:ml-10 lg:ml-20">
                ...
                <div class="mt-2 text-gray-300 text-md">
                    ...
                    <span>{{\Carbon\Carbon::parse($movieDetails['release_date'])->format('d M, Y')}}</span>
                    <span class="mx-2">|</span>
                    <span>
