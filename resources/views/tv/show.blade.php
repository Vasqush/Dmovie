...
@section('content')
    ...
    <div class="tv-info border-b border-gray-800">
        <div class="mx-auto px-8 py-8 md:pt-12 flex flex-col md:flex-row">
            <img class="h-max" src="{{$tv['poster_path']}}" alt="{{$tv['name']}}">
            <div class="mt-5 md:mt-0 md:ml-10 lg:ml-20">
                <h1 class="text-4xl font-semibold">{{$tv['original_name']}}</h1>
                <div class="mt-2 text-gray-300 text-md">
                    <svg class="inline" height="16px" width="16px" xmlns="http://www.w3.org/2000/svg"
                         xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 33 65" xml:space="preserve"
                         fill="#000000"><path style="fill:#ED8A19;"
                ...
                <p class="mt-8 text-gray-400">{{$tv['overview']}}</p>
                <div class="mt-12">
                        ...
                        @if($video['type'] == 'Trailer')
                            <div x-data="{isOpen: false}" class="inline-flex">
                                <div class="mt-1">
                                    <button
                                        @click="isOpen = true"
                                        class="flex inline-flex items-center bg-orange-400 text-gray-900 rounded-md font-semibold px-5 py-4 hover:opacity-80"
                                        target="_blank">
                                        <svg class="mr-2" fill="#000000" height="20px" width="20px"
                                             xmlns="http://www.w3.org/2000/svg"
                                             xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 60.00 60.00"
                                             xml:space="preserve" stroke="#000000" stroke-width="0.7"><g>
                ...
                <div class="grid grid-cols-2 gap-6 sm:grid-cols-3 sm:gap-8 md:grid-cols-4 lg:grid-cols-5 text-center">
                    @foreach($tv['cast'] as $cast)
                        <div class="mt-8">
                            ...
                            <div>
                                <a href="{{route('actors.show', $cast['id'])}}" class="mt-3 text-lg text-gray-50 hover:text-gray-300">
                                    {{$cast['original_name']}}
                                </a>
