<div class="my-8">
    <a href="{{route('tv.show', $tv['id'])}}" class="hover:opacity-70 transition ease-in-out duration-200">
        <img class="max-h-full" src="{{$tv['poster_path']}}" alt="{{$tv['name']}}">
    </a>
    <div>
        <a href="{{route('tv.show', $tv['id'])}}" class="mt-3 text-lg text-gray-50 hover:text-gray-300">{{$tv['name']}}</a>
